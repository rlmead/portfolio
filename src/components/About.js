    ...
    <Container>
      <Row className="mt-4 mb-5">
        <Col md={{ size: 6, offset: 3 }}>
          ...
          <p>my experience ranges from data management technologies (SQL, NoSQL, Data Version Control, API implementation & development) to web development (PHP, WordPress, Golang, JavaScript, TypeScript, React, AWS) to other common languages and tools (Git, Python, Bash, Docker).</p>
          <h3>life</h3>
          ...
          <p>my wild garden is full of lettuce, arugula, beans, tomatoes, nasturtiums, cilantro, oregano, rosemary, parsley, mint, thyme, and three varieties of basil. i also have a mulberry tree, a bountiful raspberry patch, and four young blueberry bushes that should start producing in a few years. and i'm lucky enough to live in a neighborhood with community gardens where i can forage from abundant fig, cherry, plum, and persimmon trees.</p>
        </Col>
      </Row>
    </Container>
  )
