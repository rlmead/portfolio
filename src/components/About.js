    ...
    <Container>
      <Row className="mt-4 mb-5">
        <Col md={{ size: 6, offset: 3 }}>
          <h3>work</h3>
          <p>i am a data engineer with full-stack skills. i like to build robust, functional, maintainable software. i live for creative collaboration, i love learning, and i specialize in solving puzzles.</p>
